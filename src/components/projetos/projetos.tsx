  ...
  return (
    <div className="flex flex-wrap gap-10 justify-center m-10">
      {projetos.map((projeto) => (
        ...
        >
          <div
            className="relative mx-4 -mt-6 h-40 overflow-hidden rounded-xl bg-blue-gray-500 bg-clip-border text-white shadow-lg hover:shadow-gray-500/40 bg-gradient-to-r from-red-500 to-red-600"
          >
